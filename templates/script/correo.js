...
(_a = document.getElementById('form')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (e) {
    return __awaiter(this, void 0, void 0, function () {
        var resend, response, errorData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                    resend = new resend_1.Resend('re_Fc59PYCL_NZ7hBhitzHQePnZtZGtGvWuY');
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch('/api/correo', {
                            method: 'POST',
                            headers: {
                ...
                case 4:
                    errorData = _a.sent();
                    alert("Error al enviar el correo: ".concat(errorData.error));
                    _a.label = 5;
